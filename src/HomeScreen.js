          ...
          {[
            ...
            <TouchableOpacity key={m.label} activeOpacity={0.7}
              ...
              style={{
                ...
                paddingVertical: 18, alignItems: 'center', elevation: 2
              }}>
              <View style={{
              ...
              <Text style={{ fontSize: 12, fontWeight: '600', color: C.text, marginTop: 8 }}>
                {m.label}
              </Text>
            </TouchableOpacity>
          ))}
          ...
          return (
            <Card key={p.id} onPress={() => {
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                <Text style={{
                  fontSize: 16, fontWeight: '700', color: C.text, flex: 1
                }}>
                  {p.name}
                </Text>
                <View style={{
